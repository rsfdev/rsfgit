/*
// localStorage: Data will not be removed when the browser is closed.
...
localStorage.setItem("firstname", "Roger") //change the first key
...
*/
/*
// sessionStorage: Data is removed as soon as the tab or browser is closed.
...
localStorage.setItem("firstname", "Roger")
localStorage.setItem("lastname", "Faustino")
console.log(localStorage.getItem("lastname"))

sessionStorage.setItem("firstname", "Igor")
sessionStorage.setItem("lastname", "Rez")
