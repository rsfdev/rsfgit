...
describe('convertToRoman', () => {
  test('checks if convertToRoman is defined', () => {
    expect(typeof convertToRoman).toBe('function');
  });

  test('raises an error if argument is not a number', () => {
    expect(() => convertToRoman('invalid')).toThrow('Argument must be a number');
  });

  test('raises an error if argument is less or equal to zero', () => {
    expect(() => convertToRoman(0)).toThrow('Argument must be greater than zero');
    expect(() => convertToRoman(-10)).toThrow('Argument must be greater than zero');
  });
...
describe('convertToInteger', () => {
  test('checks if convertToInteger is defined', () => {
    expect(typeof convertToInteger).toBe('function');
  });

  test('converts numbers from I to IV', () => {
  ...
  test('converts numbers from V to IX', () => {
  ...
  test('converts numbers from X to XV, XXVI and XLIII', () => {
